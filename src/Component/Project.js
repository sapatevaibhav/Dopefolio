                    ...
                    return (
                        <div className = "my-14 lg:flex lg:flex-row-reverse ">
                            <div className = "lg:w-2/3"> 
                                <a href = {url} target = "_blank" rel = "noreferrer" className = "text-base tracking-wider text-slate-100 hover:text-clr-secondary transition-colors">{name} <span><ArrowOutwardIcon sx = {{fontSize:12}}/></span></a>
